...
#define ST_READ_OUT_FLASH                     0x0005
#define ST_DISABLE_RECORDING_ON_FLASH         0x0006
#define ST_ERASE_FLASH                        0x0007
#define ST_READ_OUT_FLASH_HASH                0x0008
#define SEC_PAIRING_STATE_EVT                 0x0009
...
extern void SensorTag_enqueueMsg(uint8_t event, uint8_t serviceID, uint8_t paramID);

extern void SensorTag_updateAdvertDataContractId(uint8_t *contractId, int len);

extern void SensorTag_updateAdvertDataSensorCount(uint8_t *sensorCount);
