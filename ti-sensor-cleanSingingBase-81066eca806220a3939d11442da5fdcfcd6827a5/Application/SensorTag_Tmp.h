...
extern void SensorTagTmp_getMeasurements();

extern TempMeasurement SensorTagTmp_readSingleMeasurement();

extern void SensorTagTmp_disableRecordingOnFlash();

extern void SensorTagTmp_getMeasurementHash();
